...
| `@spinejs/throttle`             | Limitation de débit : politiques à fenêtre glissante exacte appliquées comme intercepteur de gateway ; cœur indépendant du transport avec presets HTTP (`RateLimit-*`) et electron-ipc |
